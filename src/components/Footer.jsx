...
const Footer = () => {
    return (
        <footer className="rounded-t-3xl" style={FooterBg}>
                    ...
                    <div className="grid md:grid-cols-4 md:gap-4 py-5 border-t-2 border-gray-300/10 text-black">
                        ...
                        <div className="py-8 px-4 space-y-4">
                            ...
                            <p>
                                ...
                                adipisicing elit. Ab placeat quaerat doloribus
                                odit perferendis autem blanditiis, nihil
                        ...
                        {/* Footer Links */}
                        <div className="grid grid-cols-1 md:grid-cols-3 md:col-span-3 md:ml-14">
